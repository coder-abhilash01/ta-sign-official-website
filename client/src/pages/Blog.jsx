...
import { popularSearches, faqData } from "../data/blogData";
...
const Blog = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Business Compliance & DSC Blog | TA Sign</title>
      ...
      <section className="bg-[#f8f8f6] min-h-screen">
        ...
        <section className="border-b border-neutral-200">
          ...
          <div className="w-full mx-auto px-6 md:px-16 py-14 flex flex-col lg:flex-row bg-blue-200 items-center justify-between">
            ...
            <div className="max-w-4xl">
              ...
              <h1 className="mt-8 text-5xl md:text-7xl font-semibold tracking-tight leading-[0.95]">
                DSC, Trademark &
                <br />
                Compliance Guides
              </h1>
            ...
            <div className="mt-12 w-2/3 xl:w-1/3 flex justify-end">
              ...
              <div className="bg-white border border-neutral-200 rounded-2xl px-4 h-14 flex items-center gap-3 w-full shadow-inner shadow-black/40">
              ...
              <div className="flex flex-wrap gap-3 mt-8">
                ...
                {popularSearches.map((item) => (
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-full border border-neutral-200 hover:border-[#0040FA] transition-all"
                  >
                    {item}
                  </button>
        ...
        <section className="pb-24">
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="rounded-[36px] bg-[#0f172a] px-10 py-16">
              ...
              <div className="flex flex-col lg:flex-row justify-between gap-10 lg:items-center">
                ...
                <div>
                  ...
                  <h2 className="text-4xl lg:text-5xl font-semibold text-white">
                    Need DSC or Trademark Assistance?
                  </h2>

                  <p className="mt-5 text-neutral-300 max-w-2xl">
                    Get professional assistance for Class 3 DSC,
                    Trademark Registration, ISO Certification and
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="h-14 px-7 rounded-full bg-white text-black font-medium flex items-center gap-2 w-fit"
                >
                  Talk To Expert
                  <ArrowRight size={18} />
                </a>
